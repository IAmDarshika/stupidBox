...
var stupidBox = document.querySelector('#stupidBox'),
    boxPosition = stupidBox.getBoundingClientRect();
...
var positionMaster = {},
    incrementBy = 30,
    boxSize = 100,
    boxSizeAdjusted = boxSize + incrementBy,
    widthLimit = window.innerWidth - boxSize,
    widthLimitAdjusted = window.innerWidth - boxSizeAdjusted,
    heightLimit = window.innerHeight - boxSize,
    heightLimitAdjusted = window.innerHeight - boxSizeAdjusted;
// go Forward
positionMaster.forward = (function(){
    var val = parseInt(stupidBox.style.left),
        assign = widthLimit;
    
    if(val <= widthLimitAdjusted){
        assign = val + incrementBy;
    }
    
    stupidBox.style.left = assign + 'px';
});
// go back
positionMaster.back = (function(){
    var val = parseInt(stupidBox.style.left),
        assign = 0;
    if(val > 0){
        assign = val - incrementBy;
...
// head down
positionMaster.down = (function(){
    var val = parseInt(stupidBox.style.top),
        assign = heightLimit;
    
    if(val <= heightLimitAdjusted){
        assign = val + incrementBy;
    }
    
    stupidBox.style.top = assign + 'px';
});
// head up
positionMaster.up = (function(){
    var val = parseInt(stupidBox.style.top),
        assign = 0;
    if(val > 0){
        assign = val - incrementBy;
...
stupidBox.style.top = boxPosition.top + 'px';
stupidBox.style.left = boxPosition.left + 'px';
